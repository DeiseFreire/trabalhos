#https://www.youtube.com/watch?v=nT1kSvrgmGQ&list=PL2Dw5PtrD32zzkQ1OQyN4gz3I_8G1MMHl&index=8
...
# FRAMES PRIMÁRIOS
Tops = tkinter.Frame(root, width=1350, height=100, bd=14, relief="raise")
Tops.pack(side=tkinter.TOP)
framef1 = tkinter.Frame(root, width=900, height=650, bd=8, relief="raise")
framef1.pack(side=tkinter.LEFT)
framef2 = tkinter.Frame(root, width=440, height=650, bd=8, relief="raise")
framef2.pack(side=tkinter.RIGHT)
# FRAME SECUNDÁRIOS
frameft2 = tkinter.Frame(framef2, width=440, height=450, bd=2, relief="raise")
frameft2.pack(side=tkinter.TOP)
framefb2 = tkinter.Frame(framef2, width=440, height=250, bd=2, relief="raise")
framefb2.pack(side=BUTTON)
framef1a = tkinter.Frame(framef1a, width=900, height=330, bd=2, relief="raise")
framef1a.pack(side=tkinter.TOP)
framef2a = tkinter.Frame(framef1, width=900, height=320, bd=2, relief="raise")
framef2a.pack(side=BUTTON)
framef1aa = tkinter.Frame(framef1a, width=1000, height=330, bd=2, relief="raise")
framef2a.pack(side=tkinter.LEFT)
framef1ab = tkinter.Frame(framef1a, width=450, height=330, bd=2, relief="raise")
framefab.pack(side=tkinter.RIGHT)
# CRIANDO FRAMES DO RODAPE
framef2aa = tkinter.Frame(framef2a, width=450, height=800, bd=2, relief="raise")
framef2aa.pack(side=tkinter.LEFT)
framef2ab = tkinter.Frame(framef2a, width=450, height=800, bd=2, relief="raise")
framef2ab.pack(side=tkinter.RIGHT)
frameRODAPE = tkinter.Frame(framef2a, width=211, height=190, bd=0, relief="raise")
...
# CAMPOS DOS BOTÕES
cmdTotal = Button(framefb2, padx=16, pady=1, bd=4, f'black', font=('arial', 16, 'bold'), width=5, text='Total').grid(
   row=0, column=0)
cmdRecibo = Button(framefb2, padx=16, pady=1, bd=4, f'black', font=('arial', 16, 'bold'), width=5, text='Total').grid(
   row=0, column=1)
cmdLimpar = Button(framefb2, padx=16, pady=1, bd=4, f'black', font=('arial', 16, 'bold'), width=5, text='Total').grid(
   row=0, column=2)
cmdSair = Button(framefb2, padx=16, pady=1, bd=4, f'black', font=('arial', 16, 'bold'), width=5, text='Total').grid(
   row=0, column=3)
# CRIANDO OS CAMPOS DO RODAPE  DA ESQUERDA
...
lblCustobedidas = Label(framef2ab, font=('arial', 12, 'bold'), text="Custo Bebidas :", bd=2)
lblCustobebidas.grid(row=0, column=0, sticky=tkinter.W)
