...
Cafe_comLeite= Checkbutton(framef1aa, text=”Latte \t", variable = var1, onvalue = 1, offvalue = 0, width=20, font=('arial', 18, 'bold')).grid(row=0,sticky = W) 
Expresso= Checkbutton(framef1aa, text=”Espresso \t", variable = var2, onvalue = 1, offvalue = 0, width=20, font=('arial', 18, 'bold')).grid(row=1,csticky = W) 
Cafe_comChantilly= Checkbutton(framef1aa, text=”Iced_Latte \t", variable = var3, onvalue = 1, offvalue = 0, width=20, font=('arial', 18, 'bold')).grid(row=2,sticky = W) 
Cafe_Gelado= Checkbutton(framef1aa, text=”Cafe_Gelado \t", variable = var4, onvalue = 1, offvalue = 0, width=20, font=('arial', 18, 'bold')).grid(row=2,sticky = W) 
Cafe_Cremoso= Checkbutton(framef1aa, text=”Cafe_Cortado  \t", variable = var5, onvalue = 1, offvalue = 0, width=20, font=('arial', 18, 'bold')).grid(row=3,sticky = W) 
Cafe_comChocolate= Checkbutton(framef1aa, text=”Cafe_Leite \t", variable = var6, onvalue = 1, offvalue = 0, width=20, font=('arial', 18, 'bold')).grid(row=4,sticky = W)
Cafe_Preto= Checkbutton(framef1aa, text=”Cafe_Preto \t", variable = var7, onvalue = 1, offvalue = 0, width=20, font=('arial', 18, 'bold')).grid(row=5,sticky = W)
Cafe_Creme= Checkbutton(framef1aa, text=”Cafe_Creme \t", variable = var8, onvalue = 1, offvalue = 0, width=20, font=('arial', 18, 'bold')).grid(row=6,sticky = W)   
Cappuccino= Checkbutton(framef1aa, text=”Cappuccino \t", variable = var9, onvalue = 1, offvalue = 0, width=20, font=('arial', 18, 'bold')).grid(row=7,sticky = W)  
# CRIANDO OS RADIO BUTTONS PARA OS BOLOS
Bolo_Limao = Checkbutton(framef1ab, text = "Latta \t", variable = var9, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
Bolo_Milho = Checkbutton(framef1ab, text = "Latta \t", variable = var10, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
Bolo_Morando = Checkbutton(framef1ab, text = "Latta \t", variable = var11, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
Torta = Checkbutton(framef1ab, text = "Latta \t", variable = var12, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
Bolo_Cenoura = Checkbutton(framef1ab, text = "Latta \t", variable = var13, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
Bolo_Chocolate = Checkbutton(framef1ab, text = "Latta \t", variable = var14, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
Bolo_Prestigio = Checkbutton(framef1aa, text = "Latta \t", variable = var15, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
Bolo_FlorestaNegra = Checkbutton(framef1ab, text = "Latta \t", variable = var16, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
Bolo_Pamonha = Checkbutton(framef1ab, text = "Latta \t", variable = var17, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
Bolo_SonhoDeValsa = Checkbutton(framef1ab, text = "Latta \t", variable = var18, onvalue = 1, offvalue = 0, font=('arial', 18, 'bold')).grid(row=0,sticky = W)
...
txtCustobebidas=Entry(framef2aa,font=('arial',16,'bold')bd=2,justify='left')
...
lblCustobebidas.grid(row=0,column=0,sticky=W)
txtCustobebidas=Entry(framef2ab,font=('arial',16,'bold')bd=2,justify='left')
txtCustobebidas.grid(row=0,column=1)
lblCustobedidas=Label(framef2ab,font=('arial',12,'bold'),text="Custo Bebidas :",bd=2)
lblCustobebidas.grid(row=1,column=0,sticky=W)
txtCustobebidas=Entry(framef2aa,font=('arial',16,'bold')bd=2,justify='left')
